...
const CancerDiagnosis = () => {
    ...
    const handlePredictSurvival = () => {
        ...
        if (age >= 40) {
            mockSurvivalData = {
                survivalRate: '50%',
                prognosis: 'Follow rigorous treatment protocols and frequent monitoring.',
            };
        } else if (age >= 30) {
            mockSurvivalData = {
                survivalRate: '85%',
            ...
            <div className="content">
                ...
                {result && (
                    <div className="result">
                        ...
                        <p><strong>Cancer Type:</strong> {result.cancerType}</p>
                        <p><strong>Cancer Level:</strong> {result.cancerLevel}</p>
                        ...
                        {survivalPrediction && (
                            <div className="survival-prediction">
                                ...
                                <p><strong>Survival Rate:</strong> {survivalPrediction.survivalRate}</p>
                                <p><strong>Prognosis:</strong> {survivalPrediction.prognosis}</p>
                            </div>
                        )}
                        ...
                        {treatmentGuidance && (
                            <div className="treatment-guidance">
                                ...
                                <p><strong>Treatment Type:</strong> {treatmentGuidance.treatmentType}</p>
                                <p><strong>Recommended Drugs:</strong> {treatmentGuidance.recommendedDrugs.join(', ')}</p>
                                <p><strong>Treatment Duration:</strong> {treatmentGuidance.treatmentDuration}</p>
                            </div>
                        )}
